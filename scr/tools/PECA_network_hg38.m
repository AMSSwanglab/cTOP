...
load('/public/home/wangwen_lab/lizihe/soft/PECA-master/Data/MotifMatch_human_rmdup.mat')
load('TFTG_corr.mat')
...
G=C{1,2};
%%%%CR binding
load('/public/home/wangwen_lab/lizihe/soft/PECA-master/Data/CRInfo_human.mat')
eita0=-30.4395;
eita1=0.8759;
...
%Back_net=importdata('../../Data/Back_net_mhl.txt')
load('../../Data/Back_net_mhl.mat')
